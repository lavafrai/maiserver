<#macro head>
    ...
    <link rel="stylesheet" href="/static/libs/hystmodal.min.css">
    <link rel="icon" type="image/png" href="/static/maiapp.webp"/>
    ...
    <script src="/static/libs/hystmodal.min.js"></script>
